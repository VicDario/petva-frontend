            ...
            <div className="row">
                ...
                <div className="col-12 col-md-8 mx-auto">
                    {clinic.id !== "0" ? (
                        ...
                        <div>
                            <h3>
                                Debes Seleccionar una clínica para ver sus veterinarios y reservar
                                tu hora
                            </h3>
                        </div>
                    )}
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div>
                                <h3>Selecciona para que mascota es la consulta veterinaria</h3>
                            </div>
                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                {moment(reservation.date_start).utc().format("LL")}
                                            </td>
                                            <td>
                                                {moment(reservation.date_start)
                                                    .utc()

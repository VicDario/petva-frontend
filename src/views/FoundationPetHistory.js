...
const FoundationPetHistory = () => {
    ...
    const addVaccine = () => {
        if (
            ...
            newVaccine.laboratory !== null
        ) {
            actions.addVaccinetoPetFoundation(
                formatDate(newVaccine.date),
                newVaccine.lot,
                newVaccine.name,
                newVaccine.laboratory,
                pet_id
            );
    ...
    const addDiagnostic = () => {
        if (
            newDiagnostic.date !== null &&
            newDiagnostic.diagnostic !== null &&
            newDiagnostic.doctor_name !== null
        ) {
            actions.addDiagnostictoPetFoundation(
                formatDate(newDiagnostic.date),
                newDiagnostic.diagnostic,
                newDiagnostic.doctor_name,
                pet_id
            );
    ...
    const addSurgery = () => {
        if (
            newSurgery.date !== null &&
            newSurgery.description !== null &&
            newSurgery.doctor_name !== null
        ) {
            actions.addSurgerytoPetFoundation(
                formatDate(newSurgery.date),
                newSurgery.description,
                newSurgery.doctor_name,
                pet_id
            );
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-md-3">
                        {!!foundationPet && <h1>{foundationPet.name}</h1>}
                        {!!foundationPet && (
                            <div className="card mb-3">
                                <img
                                    src={
                                        !!foundationPet.picture
                                            ? foundationPet.picture
                                            : "/images/default.jpg"
                                    }
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        Fecha Nacimiento:{" "}
                                        {!!foundationPet.birth_date
                                            ? actions.getEdad(foundationPet.birth_date)
                                            : "No registra fecha de nacimiento"}
                                    </p>
                                    <p className="card-text">
                                        N°Chip:{" "}
                                        {!!foundationPet.code_chip
                                            ? foundationPet.code_chip
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div>
                                    <label className="form-label" htmlFor="dateV">
                                        Fecha Vacuna:{" "}
                                    </label>
                                    <input
                                ...
                                <div>
                                    <label className="form-label" htmlFor="lotV">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        onChange={(e) => {
                                            setNewVaccine({ ...newVaccine, lot: e.target.value });
                                        }}
                                    />
                                </div>
                                <div>
                                    <label className="form-label" htmlFor="nameV">
                                        Nombre Vacuna:{" "}
                                    </label>
                                    <input
                                        className="form-control"
                                ...
                                <div>
                                    <label className="form-label" htmlFor="laboratoryV">
                                        Laboratorio:{" "}
                                    </label>
                                    <input
                                        className="form-control"
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <div>
                                    <label className="form-label" htmlFor="diagD">
                                        Diagnóstico:{" "}
                                    </label>
                                    <input
                                        className="form-control"
                                ...
                                <div>
                                    <label className="form-label" htmlFor="dnD">
                                        Nombre Doctor:{" "}
                                    </label>
                                    <input
                                        className="form-control"
                ...
                >
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <div>
                                    <label className="form-label" htmlFor="dateC">
                                        Fecha Cirugía:{" "}
                                    </label>
                                    <input
                                        className="form-control"
                                ...
                                <div>
                                    <label className="form-label" htmlFor="cirD">
                                        Descripción:{" "}
                                    </label>
                                    <input
                                        className="form-control"
                                ...
                                <div>
                                    <label className="form-label" htmlFor="cirDn">
                                        Nombre Doctor:{" "}
                                    </label>
                                    <input
                                        className="form-control"

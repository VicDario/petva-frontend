                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div>
                                ...
                                <input className="form-control" id="diagD" type="text" 
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div>
                                ...
                                <input className="form-control" id="cirDn" type="text" 
                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title text-center" id="encontradaLabel">
                                Nos emociona que hayas encontrado tu mascota! Pulsa cambiar estado para notificar que la has encontrado.
                            </h5>
                            <button
                                type="button"
                                className="btn-close"
